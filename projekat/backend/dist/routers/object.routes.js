...
objectRouter.route('/deleteObject').post((req, res) => new object_controller_1.ObjectController().deleteObject(req, res));
...
objectRouter.route('/changeObjectField').post((req, res) => new object_controller_1.ObjectController().changeObjectField(req, res));
